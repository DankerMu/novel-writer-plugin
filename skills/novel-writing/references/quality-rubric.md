...
| 四字词组密度(个/500字) | 0-2 | 3 | ≥ 4 或连续并列 |
| 形容词密度(个/300字) | 0-4 | 5-6 | ≥ 7 或 3+修饰同一名词 |
| 感叹号频率(个/章) | 0-8 | 9-12 | ≥ 13 或连用 |
...
**评分规则**：≥11 项人类范围 → 5 分，≥10 项无 AI 区 → 4 分，≥7 项人类或过渡 → 3 分，4-6 项 AI 区 → 2 分，≥7 项 AI 区 → 1 分。
