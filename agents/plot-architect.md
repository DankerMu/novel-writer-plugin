...
### 互动设计
{每个场景必须有 ≥2 人的动态关系。优先设计人物互动，事件从互动中生长。}
- **场景1**：{场景名}（{预估字数}字）
  - 参与者：{角色A}、{角色B}
  - 动态：{谁在试探/隐瞒/讨好/威胁谁，什么潜台词}
  - 信息传递：{通过对话/动作交代什么信息，替代旁白铺陈}
- **场景2**：...

### 质感锚点
{3-5 个具体到能用手摸到的日常物件/感官细节，CW 必须写进正文。}
- {物件1}（{功能：日常/生活痕迹/人物细节/反差美感}）
- {物件2}
- {物件3}

### 声音节拍
{主角内心独白在关键情绪节点的语气方向，给 CW 声音指引。}
- {情绪节点1}：{语气方向}（示例：{一句话示意}）
- {情绪节点2}：{语气方向}
- {情绪节点3}：{语气方向}
